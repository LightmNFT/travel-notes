...
import type { POAPABI, POAPABIInterface } from "../POAPABI";
...
const _abi = [
  ...
  {
    inputs: [],
    name: "POAPCanOnlyMintOne",
    type: "error",
  },
  {
    inputs: [],
    name: "POAPIsSoulBound",
    type: "error",
  },
  {
    inputs: [],
...
export class POAPABI__factory {
  static readonly abi = _abi;
  static createInterface(): POAPABIInterface {
    return new utils.Interface(_abi) as POAPABIInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): POAPABI {
    return new Contract(address, _abi, signerOrProvider) as POAPABI;
  }
}
